...
> Status: Approved 2.0 · 17 Confirmed · 2 Candidate · 1 Deferred

## 1. 문서 목적

이 문서는 예상문제 은행 Draft 2의 대표 문제에 대해, 도구 정확성을 검증할 수
있는 reference fixture를 관리한다. 현재 등록한 20개 중 17개는 `확정`,
0개는 `검증 중`, 2개는 `후보`이며 Deferred 1개는 문서 후보만 있다.
...
| [FX-SVC-BRG-001](./fixtures/FX-SVC-BRG-001/README.md) | SVC-BRG-001 | 1 | 후보 0.1 | Across 공개 후보·offline runner, live replay 대기 | XCHAIN, BRIDGE, RECON |
