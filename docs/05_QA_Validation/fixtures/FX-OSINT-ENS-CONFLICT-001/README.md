...
> Status: Confirmed 0.1 · Analyzer/Verifier Passed · Fixed-Block Scope
...
- [x] fixed-block fact와 현재 ownership을 동일시하지 않는 승격 문구 확인
- [x] fixed-block forward/reverse 범위로 최종 승격
