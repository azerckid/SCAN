...
4. [x] Readiness §7·Capability QA §5와 이 보고서의 checksum 분류,
   zero-value Transfer, failed internal call 등 **합집합** 19개를 synthetic
   offline으로 두 번 통과
5. [ ] timestamp 입력을 block number로 변환하는 별도 oracle 통과
