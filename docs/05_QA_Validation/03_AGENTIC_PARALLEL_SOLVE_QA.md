...
- **Mode**: offline
- **Result**: **pass** — canonical candidate·fresh replay·필수 check 재계산을
  통과하고 self-check·재사용 replay·범위 밖 ref·좁힌 pass record는 차단
- **Backlog**: `TASK-010`
...
- **Mode**: fault-injection
- **Result**: **pass** — result/evidence 충돌·누락을 보존하고 partial·
  uncertainty·`not_assessed` 후보를 `review_required`로 유지
- **Backlog**: `TASK-010`
