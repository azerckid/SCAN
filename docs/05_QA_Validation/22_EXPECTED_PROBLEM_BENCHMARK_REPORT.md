...
> Status: Passed · 16 Automated / 6 Assisted / 8 Unsupported
...
```text
EXPECTED PROBLEMS 30 · AUTOMATED 16 · ASSISTED 6 · UNSUPPORTED 8
...
| 기준 | 판정 | 증거·경계 |
|:---|:---:|:---|
| Functionality | Partial | automated 16개 exact/evidence/requirement/determinism 통과, 14개 비자동 |
...
- `FLOW-MULTI-001`은 raw contribution·합계만, OSINT-SAN/ENS와
  ACTOR-REL-002·BTC-UTXO-002·BTC-CJ-001은 도구보조다. Assisted 6·Unsupported 8
  (Lending·`MIXED-XCHAIN-001` 포함)을 유지한다.
