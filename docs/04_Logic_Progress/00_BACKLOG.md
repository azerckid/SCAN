...
- Atomic Tasks:
  ...
  - [x] 독립 Verifier가 세 candidate의 raw facts와 7개 requirement를
    두 번 재계산한다.
...
- Related QA Docs:
  ...
  - [TASK-013 독립 Verifier 보고서](../05_QA_Validation/34_TASK_013_INDEPENDENT_VERIFIER_REPORT.md) - raw-first facts·7 requirements 재계산
- Implementation Preconditions:
