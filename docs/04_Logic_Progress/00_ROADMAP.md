...
| [TASK-013 NFT·Proxy Contract](../03_Technical_Specs/14_TASK_013_NFT_PROXY_CONTRACT_PROPOSAL.md) | Candidate Replay·Negative Oracle Gates Passed | Verifier·fixture 확정·UI·Context·구현 승인 대기 |
...
| [TASK-013 Fixture 후보 보고서](../05_QA_Validation/32_TASK_013_FIXTURE_CANDIDATE_REPORT.md) | Candidate · Replay·Negative Gates Passed | 독립 Verifier 후 조건부 승격 |
