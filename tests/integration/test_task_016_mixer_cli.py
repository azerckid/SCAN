"""TASK-016 mixer_flow CLI/runtime file-path requirement tests."""
...
def test_mixer_flow_cli_completes_with_evidence_path(
    ...
    assert "COMPLETE AN-FX-SVC-MIX-001" in analyzed.stdout


def test_mixer_flow_rejects_byte_only_replay_without_file_path(tmp_path: Path) -> None:
