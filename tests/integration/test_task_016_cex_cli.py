"""TASK-016 cex_cluster CLI/runtime file-path requirement tests."""
...
def test_cex_cluster_cli_completes_with_evidence_path(
    ...
    assert "COMPLETE AN-FX-SVC-CEX-001" in analyzed.stdout


def test_cex_cluster_rejects_byte_only_replay_without_file_path(tmp_path: Path) -> None:
