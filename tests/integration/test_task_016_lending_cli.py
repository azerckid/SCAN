"""TASK-016 defi_lending CLI/runtime file-path requirement tests."""
...
def test_defi_lending_cli_completes_with_evidence_path(
    ...
    assert "COMPLETE AN-FX-SVC-LEND-001" in analyzed.stdout


def test_defi_lending_rejects_byte_only_replay_without_file_path(tmp_path: Path) -> None:
