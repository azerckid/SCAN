"""Verify the bounded offline negative-oracle pack for TASK-012."""
...
def main() -> None:
    ...
    if first != second:
        raise RuntimeError("TASK-012 negative oracle replay is not deterministic")
    print(f"PASS {len(first)} TASK-012 negative oracles twice (offline deterministic)")
